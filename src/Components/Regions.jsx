...
const Regions = () => {
  ...
  return (
    <section id='regions' className='bg-[#dbad4f] flex items-center justify-center text-5xl font-bold'>
      <div dir='ltr' className='w-full flex flex-col-reverse lg:flex-row gap-10 justify-between px-4 sm:px-6 md:px-10 py-10 sm:py-16 md:py-20'>
        <div className='w-full lg:w-1/2'>
          {/* <FlipCard region={selectedRegion} /> */}
          <Card region={selectedRegion} />
        </div>
        <div dir='ltr' className='flex flex-col gap-10 w-full lg:w-1/2 px-4 sm:px-6 md:px-10'>
          <div className='mt-50'>
            <h3 className='w-[60%] lg:w-[40%] text-end text-[30px] mt-[-10%] mr-[-10%] absolute'>قم بالضغط على المنطقة لمعرفة المزيد عنها</h3>
            <div className="w-full">
              {selectedRegion && (
                <div ref={pulseRef} className='mt-[-10%] absolute w-[10%] h-[10%] z-2'>
          ...
          <h1 dir='rtl' className='text-3xl mt-[90%] sm:text-4xl md:text-5xl lg:text-6xl text-center lg:text-right'>
