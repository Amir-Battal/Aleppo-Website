      ...
      <div className='w-full h-screen flex items-center mt-[-5%] justify-start px-10 md:px-10'>
        ...
        >
          ...
          <div className='flex flex-col items-start'>
            <h1 className='text-[320px] sm:text-[600px] md:text-[600px] lg:text-[570px] mt-[-5%] sm:mt-[-350px] md:mt-[-350px] lg:mt-[-350px] text-[#171717]'>حــلــــــــــــــــــــــــــــــــــــــــــــــــــــــب</h1>

            <div className="absolute flex flex-row justify-between w-[85%] mr-[10%] top-[53%] sm:top-[27%] md:top-[36%] lg:top-[41%]">
