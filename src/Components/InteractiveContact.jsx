...
const InteractiveContact = () => {
  ...
  return (
    <section className="relative h-[800px] bg-[#F3EDCD] pt-20 text-[#171717] flex flex-col sm:items-center md:items-start lg:items-start justify-start px-4 z-10 overflow-hidden">
      ...
      {/* الصورة التوضيحية */}
      <div className='w-full flex justify-center items-end h-[100%] z-0 absolute'>
        <img className='sm:w-[65%] md:w-[65%] xl:lg:w-[60%] w-[120%] ml-[8%] sm:ml-[0%] lg:md:ml-[-40%] absolute z-0' src={AleppoIllustration} alt="" />
      </div>
    </section>
  );
